...
/**
 * <h1>Statement process Test success!</h1>
 *
...
public class StatementProcessSuccessTest {
    ...
    @Autowired
    private FlatFileItemWriter<CustomerStatementModel> writer;

    @Value("classpath:/input/test_positive_records.csv")
    private Resource testInputResourceSuccess;

    private Resource testOutputResourceSuccess =
            new FileSystemResource("src/test/resources/output/reconciliationReportSuccess.csv");


    @Before
    public void setUp() throws Exception {
        reader.setResource(testInputResourceSuccess);
        ...
        writer.setResource(testOutputResourceSuccess);
    ...
    public void testWriter() throws Exception {
        // no reports will be generated in case of success
        AssertFile.assertLineCount(0, testOutputResourceSuccess);
    }
